      ...
      <div id='main-body' className='flex flex-col'>
        ...
        <section id='progress-status' className='flex justify-between'>
          <div className='flex flex-col sm:flex-row items-center text-center'>
            ...
            <p className='status-text hidden sm:block px-2'>Step 1: </p>
            <p className='status-text'>Cart Review</p>
          </div>
          <div className='flex flex-col sm:flex-row items-center text-center'>
            <HiCheckCircle id='status-2' />
            <p className='status-text hidden sm:block px-2'>Step 2: </p>
          ...
          <div className='flex flex-col sm:flex-row items-center text-center'>
            ...
            <p className='status-text hidden sm:block px-2'>Step 3: </p>
          ...
          <div className='flex flex-col sm:flex-row items-center text-center'>
            ...
            <p className='status-text hidden sm:block px-2'>Step 4: </p>
            <p className='status-text'>Confirmation</p>
          </div>
        </section>
        <section id='product' className='flex items-center gap-2'>
          <div id='product-details' className='hidden sm:flex flex-col gap-3'>
            <div id='product-image-1' className='flex flex-col justify-center'>
              <Image
                ...
                <div className='flex flex-col gap-2'>
                  ...
                  <div className='flex gap-2'>
                    ...
                    <div className='flex gap-2 items-center'>
                      <HiOutlineCheckBadge className='check' />
          ...
          <div className='flex flex-col gap-6'>
            ...
            <div id='product-image' className='flex justify-center sm:hidden'>
              <Image
                src='/Product_Large.svg'
                alt='product image'
                width={320}
